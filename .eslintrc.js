module.exports = {
    ...
    rules: {
        ...
        'indent': ['error', 4, { 'SwitchCase': 1 }], // 使用 2 个空格缩进，switch 语句中的 case 子句的缩进级别为1
        ...
        'no-extra-parens': 'off', // 禁止不必要的圆括号
        'no-extra-boolean-cast': 'off', // 禁止不必要的圆括号
        ...
        'no-return-assign': ['off', 'except-parens'], // 禁止在 return 语句中使用赋值语句，除非使用括号把它们括起来
